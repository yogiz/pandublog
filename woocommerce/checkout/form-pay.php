	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'pandublog' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'pandublog' ); ?></th>
			</tr>
		</thead>
		<tbody>
